...
<ul id="resourceList">
	...
	<div id="pdfs">
		...
		<li>
			<ul>
				<?php echo(' <li><a href="https://www.tutorialspoint.com/unix/unix_tutorial.pdf"> <img src="'.$path.'assets/images/firstRpdf.png" alt=" go to first PDF Recource" width="40px" height="50px"> </a></li> ');?>
				<li><a href="https://www.tutorialspoint.com/unix/unix_tutorial.pdf"> Unix Tutorail pdf </a></li>
				<?php echo(' <li><a href="http://downloads.tuxpuc.pucp.edu.pe/manuales/otros/UNIX.PDF"> <img src="'.$path.'assets/images/secondRpdf.png" alt=" go to second PDF Recource" width="40px" height="50px"></a></li> ');?>
